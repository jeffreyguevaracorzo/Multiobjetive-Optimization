...
CostFunction=@(x) MOP2(x);  % Cost Function (funcion obj es lo mismo)
...
% Empty Individual (vacio-referencia)
...
% Create Initial Population(inicializar con aleatorios)

pop=repmat(empty_individual,nPop,1);
for i=1:nPop
    pop(i).Position=unifrnd(VarMin,VarMax,VarSize);   %aleat.distri.
